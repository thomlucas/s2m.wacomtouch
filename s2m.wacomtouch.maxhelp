...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 509.0, 13.0, 173.0, 20.0 ],
					"presentation_linecount" : 2,
					"text" : "2023 update by Thomas Lucas",
...
,
					"patching_rect" : [ 49.0, 275.0, 108.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 68.0, 62.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 350.0, 43.0, 21.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 180.0, 157.0, 22.0 ],
					"saved_object_attributes" : 					{
...
,
					"patching_rect" : [ 480.0, 115.0, 73.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 408.0, 115.0, 69.0, 21.0 ],
					"text" : "observer $1"
				}
...
,
					"patching_rect" : [ 210.0, 115.0, 73.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 135.0, 90.0, 109.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 115.0, 70.0, 22.0 ],
					"text" : "xyrange $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 368.0, 220.0, 31.0, 21.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 237.0, 175.0, 183.5, 21.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 303.0, 220.0, 31.0, 21.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 237.0, 220.0, 31.0, 21.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 237.0, 195.0, 150.0, 22.0 ],
					"text" : "unpack i i i"
				}
...
,
					"patching_rect" : [ 445.0, 668.0, 68.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 340.0, 350.0, 59.472220999999998, 21.0 ],
					"triangle" : 0
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 220.105529999999987, 150.0, 32.5, 19.0 ],
									"text" : "- 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 160.0, 210.0, 199.15834000000001, 19.0 ],
									"text" : "pack f f f f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 340.422211000000004, 150.0, 34.0, 19.0 ],
									"text" : "+ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 280.316681000000017, 150.0, 34.0, 19.0 ],
									"text" : "+ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 159.947219999999987, 50.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 30.0, 375.0, 391.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 443.0, 210.0, 142.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 450.920929000000001, 22.0, 49.079116821289062, 14.249397277832031 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 570.0, 120.0, 100.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 460.0, 185.0, 63.0, 22.0 ],
					"text" : "print infos"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 305.0, 115.0, 47.0, 21.0 ],
					"text" : "getinfo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.75, 115.0, 45.0, 21.0 ],
					"text" : "nopoll"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 115.0, 32.5, 21.0 ],
					"text" : "poll"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 278.105560000000025, 350.0, 54.472220999999998, 21.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 216.0, 350.0, 41.472220999999998, 21.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 154.211090000000013, 350.0, 41.472220999999998, 21.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 91.788910000000001, 350.0, 43.0, 21.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 300.0, 328.527770999999973, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 150.0, 639.0, 24.0 ],
					"text" : "s2m.wacomtouch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 20.0, 48.0, 20.0 ],
					"text" : "onecopy"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 452.833333333333314, 178.0, 469.5, 178.0 ],
					"order" : 0,
					"source" : [ "obj-3", 2 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 8/Library/s2m.wacomtouch1.1",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
